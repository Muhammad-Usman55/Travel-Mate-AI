...
export function AgentActivity() {
  ...
  return (
    <div className={`rounded-xl border overflow-hidden transition-all duration-300 ${allDone
      ...
      >
        <div className="flex items-center gap-2.5">
          ...
          <span className={`text-sm font-medium ${allDone
      ...
      {expanded && (
        <div className="px-4 pb-3 grid grid-cols-5 gap-2">
          {agents.map((agent) => (
            <div
              key={agent.name}
              className={`flex flex-col items-center gap-1.5 py-2 px-1 rounded-lg transition-colors ${agent.status === 'done'
            ...
            >
              ...
              <span className={`text-[10px] font-medium text-center leading-tight ${agent.status === 'done'
